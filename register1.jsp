	...
	<div id="page">
		<div id="content">
			<div class="post">
				...
				<div class="entry">
				        <s:form action="register12">
            <s:textfield name="userName" label="User Name" />
            <s:password name="password" label="Password" />
		<s:textfield name="companyname" label="Company name"/>
		<s:textfield name="faxnumber" label="Fax number"/>
		<s:textfield name="emailid" label="Email-id"/>
		<s:textarea name="address" label="Address" />
		<s:textarea name="queries" label="If you have any queries you can ask" />
		<s:textarea name="comments" label="Post your comments here" />
